...
function calcualteTotalCost(itemsBoughtArr) {
  const total = itemsBoughtArr.reduce((total, current) => {
    return total + current.priceUSD;
  }, 0);
  return total;
}

console.log(calcualteTotalCost(itemsBoughtArr));
